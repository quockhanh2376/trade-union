...
> **Note:** The legacy Python CLI (`cli.py`, `trade_union.py`, `test_trade_union.py`)
> and the standalone script `AddEmailsToDistList.ps1` have been removed. They
> were superseded by the Tauri app and `src-tauri/scripts/manage_distribution_group.ps1`.
